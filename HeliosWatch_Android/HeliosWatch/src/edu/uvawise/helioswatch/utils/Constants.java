...
package edu.uvawise.helioswatch.utils;

public class Constants {

	
	// Notification intent action string
	public static final String NOTIFICATION_LISTENER_SERVICE = "edu.uvawise.helioswatch.NOTIFICATION_LISTENER_SERVICE";
	public static final String NOTIFICATION_LISTENER = "edu.uvawise.helioswatch.NOTIFICATION_LISTENER";
