...
package edu.uvawise.helioswatch.service;

import java.util.ArrayList;
import java.util.Timer;
import java.util.TimerTask;

import edu.uvawise.helioswatch.R;
import edu.uvawise.helioswatch.connectivity.BluetoothManager;
import edu.uvawise.helioswatch.connectivity.ConnectionInfo;
import edu.uvawise.helioswatch.connectivity.TransactionBuilder;
import edu.uvawise.helioswatch.connectivity.TransactionBuilder.Transaction;
import edu.uvawise.helioswatch.connectivity.TransactionReceiver;
import edu.uvawise.helioswatch.contents.ContentManager;
import edu.uvawise.helioswatch.contents.IContentManagerListener;
import edu.uvawise.helioswatch.contents.objects.CPObject;
import edu.uvawise.helioswatch.contents.objects.ContentObject;
import edu.uvawise.helioswatch.contents.objects.EmergencyObject;
