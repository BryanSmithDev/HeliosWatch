 ...
 */
public class HeliosWatchFragmentAdapter extends FragmentPagerAdapter {

	public static final String TAG = "HeliosWatchFragmentAdapter";
	...
	public HeliosWatchFragmentAdapter(FragmentManager fm, Context c, IFragmentListener l) {
		super(fm);
		mContext = c;
		mFragmentListener = l;
	}
