...
package com.hardcopy.helioswatchle;

import java.util.ArrayList;
import java.util.Timer;
import java.util.TimerTask;

import com.hardcopy.helioswatchle.contents.objects.CPObject;
import com.hardcopy.helioswatchle.contents.objects.ContentObject;
import com.hardcopy.helioswatchle.contents.objects.FilterObject;
import com.hardcopy.helioswatchle.service.HeliosWatchService;
import com.hardcopy.helioswatchle.utils.Constants;
import com.hardcopy.helioswatchle.utils.Logs;
import com.hardcopy.helioswatchle.utils.RecycleUtils;
import com.hardcopy.helioswatchle.utils.Utils;
...
public class HeliosWatchActivity extends FragmentActivity implements ActionBar.TabListener, IFragmentListener {

    // Debugging
    private static final String TAG = "HeliosWatchActivity";
    
    private static final long REMOTE_REFRESH_DELAY = 3*1000;
	
	// Context, System
	private Context mContext;
	private HeliosWatchService mService;
	...
	private HeliosWatchFragmentAdapter mSectionsPagerAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSectionsPagerAdapter = new HeliosWatchFragmentAdapter(mFragmentManager, mContext, this);
	...
	public void OnFragmentCallback(int msgType, int arg0, int arg1, String arg2, String arg3, Object arg4) {
		...
		case IFragmentListener.CALLBACK_REQUEST_ADD_FILTER:
			...
			if(id > Constants.RESPONSE_ADD_FILTER_FAILED) {
				FiltersFragment frg = (FiltersFragment) mSectionsPagerAdapter.getItem(HeliosWatchFragmentAdapter.FRAGMENT_POS_FILTERS);
				frg.addFilter(filterObj);
				
				ArrayList<ContentObject> contents = mService.refreshContentObjectList();
				MessageListFragment frg2 = (MessageListFragment) mSectionsPagerAdapter.getItem(HeliosWatchFragmentAdapter.FRAGMENT_POS_MESSAGE_LIST);
		...
		case IFragmentListener.CALLBACK_REQUEST_ADD_RSS:
			...
			if(mService != null && arg4 != null) {
				...
				if(id5 > -1) {
					RssFragment frg = (RssFragment) mSectionsPagerAdapter.getItem(HeliosWatchFragmentAdapter.FRAGMENT_POS_RSS);
					frg.addRss(cpObj);
				}
			}
			break;
	...
	private void doStartService() {
		...
		startService(new Intent(this, HeliosWatchService.class));
		bindService(new Intent(this, HeliosWatchService.class), mServiceConn, Context.BIND_AUTO_CREATE);
	}
	
	private void doStopService() {
		Logs.d(TAG, "# Activity - doStopService()");
		mService.finalizeService();
		stopService(new Intent(this, HeliosWatchService.class));
	}
	...
	private void initialize() {
		...
		// HeliosWatchService.setupBT() will then be called during onActivityResult
	...
	public class ActivityHandler extends Handler {
		...
		public void handleMessage(Message msg) 
		{
			...
			case Constants.MESSAGE_ADD_NOTIFICATION:
			{
				...
				MessageListFragment frg = (MessageListFragment) mSectionsPagerAdapter.getItem(HeliosWatchFragmentAdapter.FRAGMENT_POS_MESSAGE_LIST);
				if(frg != null)
					frg.addMessage(obj);
				break;
			}
